...
# input dimension = (batch_size, mix_mel_spec_size)
# output dimension = (batch_size * 9 * 1024) -> maximum 9 embedding of tracks in mixture
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.linear2 = nn.Sequential(
            nn.Linear(in_features=1024, out_features=1024 * 9),
        )
