...
from numpy import zeros, ones, array, arange, argsort, column_stack, hstack, vstack, abs, concatenate
from tqdm.auto import tqdm
from collections import namedtuple

Box = namedtuple("Box", "left right top bottom")

def compute_eer_det(feat, label, enroll_num=5, tar_num=20, nontar_num=20, save_dir=None, seed=0): 
