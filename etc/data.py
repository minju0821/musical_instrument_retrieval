...
class InstrumentDataset(Dataset):
    def __init__(self, split='train', nsynth_path="/disk2/aiproducer_inst/nsynth/", 
                    midi_path="/disk2/aiproducer_inst/clean_midi_inst_new/",
                    duration_in_seconds=1., min_notes=2, num_classes=953):
