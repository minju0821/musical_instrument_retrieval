...
if __name__=='__main__':
    ...
    net = ConvNet_new(activ=args.activ, out_classes=args.num_class).to(DEVICE)
    ...
    train_dataset = RenderedInstrumentDataset(split='train', num_classes=args.num_class)
    ...
    while True:
        ...
        if epoch % 5 == 0:
            torch.save(net.state_dict(), './model_batch32_newData/class{}_epoch{}_trLoss_{:.3f}_trAcc{:.3f}'.format(args.num_class, epoch, train_loss, train_acc))
